...
my_answers = {
    ...
    '4': 'cat>name.txt and touch',    # Укажите команду в терминале для создания файла
    ...
    '15': 'substring? replace',   # Какой метод заменит указанные нами символы/подстроки на новые символы/подстроки
    ...
    '30': '_',   # Какой оператор не делает ничего
}
