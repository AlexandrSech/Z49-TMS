...
my_answers = {
    ...
    '4': 'nano',    # Укажите команду в терминале для создания файла
    ...
    '7': 'flow',    # Какой тип данных нужен для работами с дробными числами
    ...
    '21': 'setdefault()',   # Какой метод возващает либо значение по ключу, либо стандартное значение в словарях
