...
my_answers = {
    ...
    '15': '.insert()',   # Какой метод заменит указанные нами символы/подстроки на новые символы/подстроки
    '16': 'новую изменённую строку',   # Что возвращают методы из предыдущих двух вопросов (ничего, новую измененную строку)
    ...
    '21': '.pop()',   # Какой метод возващает либо значение по ключу, либо стандартное значение в словарях
    '22': 'False',   # Что вернет 12 < 1
    '23': '30',   # Что вернет 3 + 3 ** 3
    '24': 'True',   # Что вернет в if [] - True или False
    '25': 'Список',   # Какой тип данных вернет splitlines()
