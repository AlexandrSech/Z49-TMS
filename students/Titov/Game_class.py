class Snake:
    ...
    def make_step(self):
        self.blocks.insert(0,
                           (self.blocks[0][0] + (block_size * part * self.directions[self.direction][0]))
                           (self.blocks[0][1] + (block_size * part * self.directions[self.direction][1]))
                           )
        self.blocks.pop()
        print(self.blocks.insert(0))
