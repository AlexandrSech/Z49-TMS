...
my_answers = {
    ...
    '14': 'insert',   # Какой метод поможет нам вставлять в готовую строку в нужных местах значения переменных
    ...
    '25': 'tuple',   # Какой тип данных вернет splitlines()
